...
public class Tip {
        ...
        int electricityTipsNotRepeat[]=  {7,7,7,7,7, 7,7,7,7,7, 7,7,7,7,7, 7,7,7,7,7};      //4 tips
        int gasTipsNotRepeat[]=  {7,7,7,7,7, 7,7,7,7,7, 7,7,7,7,7, 7,7,7,7,7};                  //4 tips
        // total 34 tips for journey(include, walk,bike,bus,skytrain)
        // total 8 tips for utilities(electricity  and gas)
        ...
        // 4 tips of ElectricityEmissions
        private String tipsForElectricityEmissions() {
            ...
            if(totalElectricityEmissions <worldAve && electricityTipsNotRepeat[0] >= 7)
            {
                String tip="You generate: "
                        ...
                        "which is lower than average level of world.";
                    ...
                    && electricityTipsNotRepeat[1] >= 7)
            {
                String tip="You generate: "
                        ...
                        "average level of Canada";
                electricityTipsNotRepeat[1] = 1;
                return tip;
            }
            else if(totalElectricityEmissions >=canadaAve && totalElectricityEmissions < 2*canadaAve
                    && electricityTipsNotRepeat[2] >= 7)
            {
                String tip="You generate: "
                        +totalElectricityEmissions +"kg  of CO2 today from Electricity use, " +
                        "which is greater than average level of Canada, " +
                        "turn off lights after leaving room, or turn the air condition lower" +
                        "may reduce the emission.";
                electricityTipsNotRepeat[2] = 1;
                return tip;
            }
            else if(totalElectricityEmissions >=2* canadaAve && electricityTipsNotRepeat[3] >= 7)
            {
                String tip="You generate: "
                        +totalElectricityEmissions +"kg  of CO2 today from Electricity use, " +
                        "which is two times greater than average level of Canada," +
                        "turn off lights after leaving room, or turn the air condition lower" +
                        "may reduce the emission.";
        ...
        private String tipsForGasEmissions() {
            ...
            {
                String tip="You generate: "
                        +totalGasEmissions +"kg  of CO2 today from Electricity use, " +
                        "which is greater than average level of world, but lower than" +
                        "average level of Canada";
                gasTipsNotRepeat[1] = 1;
                return tip;
            }
            else if(totalGasEmissions >=canadaAve && totalGasEmissions < 2*canadaAve
                    && gasTipsNotRepeat[2] >= 7)
            {
                String tip="You generate: "
                        +totalGasEmissions +"kg  of CO2 today from Electricity use, " +
                        "which is greater than average level of Canada, " +
            ...
            else if(totalGasEmissions >=2* canadaAve && gasTipsNotRepeat[3] >= 7)
            {
                String tip="You generate: "
                        +totalGasEmissions +"kg  of CO2 today from Electricity use, " +
                        "which is two times greater than average level of Canada," +
