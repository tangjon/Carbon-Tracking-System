...
public class Tip {
    ...
    public String getJourneyTip(Context c) {
        String tips = tipsForWalk(c);
        if (tips.length() > 2) {
            ...
            if (tips.length() > 2) {
                ...
                tips = tipsForJourneyTotalEmissions(c);
                if (tips.length() > 2) {
                    return tips;
                }
            }
    ...
    public String tipsForWalk(Context c) {
        ...
        if (totalWalk == 0.0 && walkTipsNotRepeat[0] > 8) {
            ...
            String tip = c.getString(R.string.tip_walk4) + totalWalk +
                    c.getString(R.string.tip_walk_more);
            ...
            String tip = c.getString(R.string.tip_walk_only);
    ...
    public String tipsForJourneyTotalEmissions(Context c) {
        ...
        if (totalJourneyEmissions == 0 && totalBike == 0 && totalWalk == 0 &&
            ...
            String tip = c.getString(R.string.tip_journey1);
            ...
            String tip = c.getString(R.string.tip_journey2) + totalJourneyEmissions +
                    c.getString(R.string.tip_journey2_1);
            ...
            String tip = c.getString(R.string.tip_journey3) + totalJourneyEmissions +
                    c.getString(R.string.tip_journey3_1);
